...
fun ScreenCaptureOverlay(
    ...
    CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Ltr) {
        BoxWithConstraints(
            modifier = Modifier
                .fillMaxSize()
                .background(Color(0xCC000000)) // 80% black scrim so the user can see through
        ) {
            ...
            Canvas(
                ...
                val dimPath = Path().apply {
                    ...
                    op(this, selPath, Path.Operation.Difference)
                }
                drawPath(dimPath, color = Color(0xCC000000))
                // Selection outline
                drawRect(
